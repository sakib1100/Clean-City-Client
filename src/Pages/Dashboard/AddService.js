      ...
      <div className="card flex-shrink-0  lg:w-full max-sm:w-9/12 max-w-sm shadow-2xl bg-base-100">
        ...
        <h1 className='text-3xl bolder text-center text-accent'>Add Service</h1>
          ...
          <div className="form-control">
            ...
            <input name="cName" type="text" placeholder="Service Name"  className="input border-accent border input-bordered" />
          </div>
          <div className="form-control">
            <label className="label">
              <span className="label-text">Service Charge</span>
            </label>
            <input name="charge" type="text" placeholder="Service Charge" className="input  border-accent border input-bordered" />
          ...
          <div className="form-control">
            ...
            <input  onChange={handleImage} type="file"  className="input   border-accent border input-bordered" />
